inherited FormCadastroDepartamento: TFormCadastroDepartamento
  ...
  object ButtonPesquisarEmpresa: TSpeedButton [4]
    Left = 119
    Top = 28
    Width = 30
    Height = 23
  ...
  object editCodEmpresa: TDBEdit [9]
    Left = 71
    Top = 28
    Width = 48
    Height = 21
  ...
  inherited Query: TIBQuery
    ...
    object QueryEMPRESA_CD_EMPRESA: TIntegerField
      ...
      Origin = '"DEPARTAMENTO"."EMPRESA_CD_EMPRESA"'
      Required = True
    end
  ...
  inherited Update: TIBUpdateSQL
    ...
    ModifySQL.Strings = (
      ...
      'where'
      '  CD_DEPARTAMENTO = :OLD_CD_DEPARTAMENTO')
    InsertSQL.Strings = (
      'insert into DEPARTAMENTO'
      '  (CD_DEPARTAMENTO, NM_DEPARTAMENTO, EMPRESA_CD_EMPRESA)'
      'values'
      '  (:CD_DEPARTAMENTO, :NM_DEPARTAMENTO, :EMPRESA_CD_EMPRESA)')
    DeleteSQL.Strings = (
