inherited FormCadastroCartaoPontos: TFormCadastroCartaoPontos
  Caption = 'Cadastro de cartao de pontos'
  ClientHeight = 143
  ClientWidth = 503
  ExplicitWidth = 509
  ExplicitHeight = 172
  ...
  object Label5: TLabel [5]
    ...
    FocusControl = EditNome_cliente
  end
  object ButtonPesquisarCliente: TSpeedButton [6]
    Left = 123
    Top = 32
    Width = 33
    Height = 23
    ...
    NumGlyphs = 2
    OnClick = ButtonPesquisarClienteClick
  end
  ...
  object EditCodCliente: TDBEdit [9]
    Left = 75
    Top = 33
    Width = 48
    Height = 21
  ...
  object EditNome_cliente: TDBEdit [11]
    Left = 266
    Top = 32
    Width = 235
    Height = 21
  ...
  object EditdataCriacao: TDBEdit [12]
    Left = 235
    Top = 5
    Width = 139
    Height = 21
    CharCase = ecUpperCase
    DataField = 'DATA_CARTAO'
    DataSource = ds
    ReadOnly = True
    TabOrder = 5
  end
  inherited Query: TIBQuery
    SQL.Strings = (
      'SELECT CARTAO_PONTOS.*, CLIENTE.NM_CLIENTE'
      ''
      'FROM CARTAO_PONTOS'
      ''
      'INNER JOIN CLIENTE'
      ''
      'ON (CARTAO_PONTOS.CLIENTE_CD_CLIENTE = CLIENTE.CD_CLIENTE)'
      ''
      '')
    ...
    object QueryDATA_CARTAO: TDateField
      DisplayLabel = 'Data de cria'#231#227'o'
      FieldName = 'DATA_CARTAO'
      Origin = '"CARTAO_PONTOS"."DATA_CARTAO"'
      Required = True
  ...
  inherited Update: TIBUpdateSQL
    RefreshSQL.Strings = (
      ...
      'from CARTAO_PONTOS '
      'where'
      '  NUN_CARTAO = :NUN_CARTAO')
    ModifySQL.Strings = (
      'update CARTAO_PONTOS'
      'set'
      '  NUN_CARTAO = :NUN_CARTAO,'
      '  DATA_CARTAO = :DATA_CARTAO,'
      '  CLIENTE_CD_CLIENTE = :CLIENTE_CD_CLIENTE,'
      '  ACUMULA_PONTOS = :ACUMULA_PONTOS'
      'where'
      '  NUN_CARTAO = :OLD_NUN_CARTAO')
    InsertSQL.Strings = (
      'insert into CARTAO_PONTOS'
      '  (NUN_CARTAO, DATA_CARTAO, CLIENTE_CD_CLIENTE, ACUMULA_PONTOS)'
      'values'
      
        '  (:NUN_CARTAO, :DATA_CARTAO, :CLIENTE_CD_CLIENTE, :ACUMULA_PONT' +
        'OS)')
    DeleteSQL.Strings = (
      'delete from CARTAO_PONTOS'
      'where'
      '  NUN_CARTAO = :OLD_NUN_CARTAO')
  end
