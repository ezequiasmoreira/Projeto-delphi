object FormrelatorioFornecedor_campanha: TFormrelatorioFornecedor_campanha
  Left = 0
  Top = 0
  Caption = 'Relat'#243'rio de fornecedores que participaram de campanha'
  ClientHeight = 201
  ClientWidth = 447
  Color = clBtnFace
  ...
  object RadioFornecedor: TRadioGroup
    Left = 8
    Top = 8
    Width = 423
    Height = 81
  ...
  object Query: TIBQuery
    ...
    ParamCheck = True
    SQL.Strings = (
      'SELECT CAMPANHA.COD_CAMPAN, CAMPANHA. DATA_INICIAL,'
      ...
      ''
      'ON (FORNECEDOR.CD_FORNECEDOR ='
      '      CAMPANHA.FORNECEDOR_CD_FORNECEDOR)'
      ''
      ''
      'ORDER BY  CAMPANHA.NM_CAMPAN;')
    Left = 240
    Top = 152
  end
  object reportFor_campanha: TfrxReport
    Version = '5.1.5'
    ...
    ReportOptions.CreateDate = 43048.963423599500000000
    ReportOptions.LastChange = 43048.963423599500000000
    ...
    object Page1: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object frxDBDataset1COD_CAMPAN: TfrxMemoView
          ...
          DataSetName = 'frxDBDataset1'
          Memo.UTF8W = (
            'C'#243'd. campanha: [frxDBDataset1."COD_CAMPAN"]')
        end
        object frxDBDataset1DATA_INICIAL: TfrxMemoView
          ...
          DataSetName = 'frxDBDataset1'
          Memo.UTF8W = (
            'Periodo:  [frxDBDataset1."DATA_INICIAL"] ')
        end
        object frxDBDataset1DATA_FINAL: TfrxMemoView
        ...
        object frxDBDataset1NM_CAMPAN: TfrxMemoView
          ...
          DataSetName = 'frxDBDataset1'
          Memo.UTF8W = (
            'Campanha: [frxDBDataset1."NM_CAMPAN"]')
        end
      end
      ...
      object GroupHeader1: TfrxGroupHeader
        ...
        Width = 718.110700000000000000
        Condition = 'frxDBDataset1."COD_CAMPAN"'
  ...
  object DatasetFor_campanha: TfrxDBDataset
