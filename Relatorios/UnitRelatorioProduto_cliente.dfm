object FormRelatorioProduto_cliente: TFormRelatorioProduto_cliente
  Left = 0
  Top = 0
  ...
  object Radiocliente: TRadioGroup
    Left = 8
    Top = 16
    Width = 417
    Height = 65
  ...
  object ReportProduto_cliente: TfrxReport
    Version = '5.1.5'
    ...
    ReportOptions.CreateDate = 43046.832940196800000000
    ReportOptions.LastChange = 43046.832940196800000000
    ...
    Datasets = <
      item
        DataSet = DatasetProduto_cliente
    ...
    object Page1: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        DataSetName = 'frxDBDataset1'
        RowCount = 0
        object frxDBDataset1CD_VENDA: TfrxMemoView
        ...
        object frxDBDataset1NM_PRODUTO: TfrxMemoView
          ...
          DataSetName = 'frxDBDataset1'
          Memo.UTF8W = (
            '[frxDBDataset1."NM_PRODUTO"]')
        end
        object frxDBDataset1P_VENDA: TfrxMemoView
          ...
          DataSetName = 'frxDBDataset1'
          Memo.UTF8W = (
            'Pre'#231'o [frxDBDataset1."P_VENDA"]')
        end
      end
      ...
      object GroupHeader1: TfrxGroupHeader
        ...
        Width = 718.110700000000000000
        Condition = 'frxDBDataset1."CD_CLIENTE"'
        object frxDBDataset1CD_CLIENTE: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            'C'#243'digo [frxDBDataset1."CD_CLIENTE"]')
          ParentFont = False
        end
  ...
  object DatasetProduto_cliente: TfrxDBDataset
  ...
  object Query: TIBQuery
    ...
    SQL.Strings = (
      ''
      'SELECT CLIENTE.CD_CLIENTE  , CLIENTE.NM_CLIENTE,'
